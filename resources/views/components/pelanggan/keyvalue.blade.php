        ...
        <div class="keyvalue">
            <div class="value">
                ...
                <div class="value-text">
                    <span class="title f-title-md">Bersih dan Terawat</span>
            ...
            <div class="value">
                ...
                <div class="value-text">
                    <span class="title f-title-md">Perawatan Service Rutin</span>
            ...
            <div class="value">
                ...
                <div class="value-text">
                    <span class="title f-title-md">Pilihan Tipe Motor</span>
                    <p class="desc f-body">kamu bisa memilih berbagai pilihan tipe sepeda motor, semua berumur dibawah 3 tahun aman & nyaman.</p>
                </div>
            </div>
        </div>
    </div>
