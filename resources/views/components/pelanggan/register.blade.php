<div class="register">
    ...
    <form action="#" class="register-form" method="POST">
        ...
        <div class="form-input confirm-password f-body">
            ...
            <input type="password" name="password" id="confirm-password" placeholder="Re-enter your password"/>
        </div>
        ...
        <a class="btn btn-md btn-full btn-blue" type="submit">Register</a>
    </form>
    <div class="register-info">
        <span class="register-text">Has an account? <a href="#" title="register">Login here</a></span>
